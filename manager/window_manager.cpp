...
bool WindowManager::wants_close()
{
...
const GNF_UVec2* WindowManager::get_size_r() const noexcept
{
	return m_size.get();
}

const ConfigProperty<GNF_UVec2>* WindowManager::get_size() const noexcept
{
	return &m_size;
}
